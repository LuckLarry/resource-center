...
class ProductImagesControllerTest < ActionController::TestCase
  ...
  test "should create product_image" do
    assert_difference('ProductImage.count') do
      post :create, product_image: { image_id: @product_image.image_id, position: @product_image.position, sku: @product_image.sku, tag: @product_image.tag }
    end
  ...
  test "should update product_image" do
    patch :update, id: @product_image, product_image: { image_id: @product_image.image_id, position: @product_image.position, sku: @product_image.sku, tag: @product_image.tag }
    assert_redirected_to product_image_path(assigns(:product_image))
  end
